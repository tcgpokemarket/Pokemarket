      ...
      <div className="pt-24 pb-16 max-w-2xl mx-auto px-4 sm:px-6">
          ...
          <div className="mt-4 space-y-3 rounded-2xl border border-yellow-400/20 bg-yellow-400/10 p-4">
            <div>
              ...
              <p className="mt-1 text-sm text-gray-300">
                First 100 completed sales are fee-free for the marketplace fee. After that, fees start at 5%, with lower power seller tiers available.
              </p>
            </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center justify-end gap-4">
            ...
            <button type="submit" disabled={loading} className="px-6 py-3 rounded-xl bg-yellow-400 text-black font-bold hover:bg-yellow-300 disabled:opacity-50">{loading ? "Publishing..." : "Publish Listing"}</button>
          </div>
        </form>
      </div>
    </div>
