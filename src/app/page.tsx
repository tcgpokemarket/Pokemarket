      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <section className="rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-10">
          ...
          <div className="mt-3 flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex gap-3"><Link href="/listings" className="rounded-xl bg-yellow-400 px-5 py-3 font-black text-black">Browse listings</Link><Link href="/sell" className="rounded-xl border border-white/15 px-5 py-3 font-bold">Sell cards</Link></div>
          </div>
        </section>
